...
namespace CreditCardManagementSystem
{
    ...
    { 
        ...
        public void issueNewCreditCard()
        {
            ...
            while(customer.CardRequests > 0)
            {
                ...
                if(customer.Cards.Count < 5)
                {
                    ...
                    Console.WriteLine("Credit card issued successfully!!");
                }
                else {
        ...
        public void spend(int purchasedAmt)
        {
            ...
            int balance = customers_al[customerFinderResult].Card[cardFinderResult].Balance;
            ...
            {
                customers_al[customerFinderResult].Card[cardFinderResult].Balance = balance - purchasedAmt;
                Console.WriteLine("Thankyou!! Payment Success!! Current balance = " + customers_al[customerFinderResult].Card[cardFinderResult].Balance);
            }
        }
